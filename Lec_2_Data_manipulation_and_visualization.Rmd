...
homo %>% 
  ...
  geom_point() + 
  facet_grid(older_then_28~orientation, margins = TRUE)
```

[![](https://github.com/agricolamz/2017-MAG_R_course/blob/master/Lec_2_Data_manipulation_and_visualization_files/figure-slidy/unnamed-chunk-99-1.png)](https://github.com/agricolamz/2017-MAG_R_course/blob/master/Lec_2_Data_manipulation_and_visualization_files/figure-slidy/unnamed-chunk-99-1.png)
